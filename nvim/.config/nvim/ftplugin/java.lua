...
local on_attach = function(_, bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "crc", "<Cmd>lua require('jdtls').extract_constant()<CR>", opts)
...
local config = {
	...
	cmd = {
		...
		-- 💀
		"/usr/lib/jvm/openjdk17/bin/java", -- or '/path/to/java11_or_newer/bin/java'
