 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    PDFJS.imageResourcesPath = './SlGlasnikPortal/pdfjs/web/images/';
    PDFJS.workerSrc = '/SlGlasnikPortal/pdfjs/build/pdf.worker.js';
    PDFJS.cMapUrl = '/SlGlasnikPortal/pdfjs/web/cmaps/';
   ...
   var PDFViewerApplication = {
    ...
    open: function pdfViewOpen(file, args) {
     ...
     parameters.httpHeaders = {'X-Referer' : '/SlGlasnikPortal/pdfjs/build/pdf.worker.js'};
     var self = this;
   ...
   function webViewerInitialized() {
    ...
    file = path === 'REPLACE_PATH' ? window.location.href.substring(window.location.href.indexOf('file=') + 5) : path;
   ...
   webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file) {
    ...
    if (file && file.lastIndexOf('file:', 0) === 0) {
     ...
     alert('REFERER');
     xhr.setRequestHeader('X-Device', 'phone');
     xhr.onload = function () {
